# Define variables
$printerName = "WMS-2ndFlr Library BizHubC550i"
$printerIP = "172.16.1.78"
...
$driverURL = "https://thewindwardschool.io/winpatch/KM_UniversalDriver_PCL_3.9.818.500_WHQL.zip"
$infFilePath = "$driverExtractPath\KM_UniversalDriver_PCL_3.9.818.500_WHQL\Driver\Win_x64\KOAWUJ__.inf"
