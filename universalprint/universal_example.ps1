...
$printerName = "NYC-3rd Floor-Faculty Lounge Ricoh 5300"
# What is the IP address of that printer?
$printerIP = "192.168.32.73"
...
try {
    ...
    $scriptContent = Invoke-RestMethod -Uri "https://thewindwardschool.io/winpatch/printer/ricoh_universal.ps1" -UseBasicParsing
